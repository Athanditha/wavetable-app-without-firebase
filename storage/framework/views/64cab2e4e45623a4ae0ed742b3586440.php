...
<body class="bg-white text-gray-900 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-xl mx-auto px-6">
        ...
        <div class="text-center mb-12">
            <img src="<?php echo e(asset('logolight.png')); ?>" alt="WaveTable Logo" class="w-48 mx-auto mb-8">
...
</html><?php /**PATH C:\xampp\htdocs\wavetable-app\resources\views/adminlanding/admin.blade.php ENDPATH**/ ?>