        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white p-0 rounded-lg overflow-hidden shadow-lg">
                    <img src="<?php echo e(asset('Sound-Design-Studio-Mixer.jpg')); ?>" alt="Gallery Image 1" class="w-full h-64 object-cover">
                </div>
                <div class="bg-white p-0 rounded-lg overflow-hidden shadow-lg">
                    <img src="<?php echo e(asset('salvatoreganacci.jpg')); ?>" alt="Gallery Image 2" class="w-full h-64 object-cover">
                </div>
                <div class="bg-white p-0 rounded-lg overflow-hidden shadow-lg">
                    <img src="<?php echo e(asset('Bring-Me-The-Horizon.jpg')); ?>" alt="Gallery Image 3" class="w-full h-64 object-cover">
                </div>
                <div class="bg-white p-0 rounded-lg overflow-hidden shadow-lg">
                    <img src="<?php echo e(asset('studio-picture.jpg')); ?>" alt="Gallery Image 4" class="w-full h-64 object-cover">
                </div>
            </div>
        </div>
    </section>
...
<?php /**PATH C:\xampp\htdocs\wavetable-app\resources\views/customer/welcome.blade.php ENDPATH**/ ?>