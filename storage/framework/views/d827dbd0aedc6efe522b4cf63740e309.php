                        ...
                        <div class="bg-white rounded-xl overflow-hidden group hover:shadow-xl transition duration-300 border border-gray-200">
                            <div class="relative aspect-square overflow-hidden">
                                ${item.image 
                                    ...
                                    : `<img src="<?php echo e(asset('images/default-image.jpg')); ?>" alt="${item.name}" class="w-full h-full object-cover group-hover:scale-110 transition duration-300">`
                                }
...
<?php /**PATH C:\xampp\htdocs\wavetable-app\resources\views/customer/home.blade.php ENDPATH**/ ?>